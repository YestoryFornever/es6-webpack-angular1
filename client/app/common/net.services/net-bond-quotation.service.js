app.factory('NetBondquotationService', function($http,$q,$uibModal, ProxyRequestService){
	...
	return {
		...
		queryScmList(obj){
			console.log(obj)
			return ProxyRequestService.post('e-bondquote/bondScm/queryScmList', obj||{
		...
		//删除自选方案
		deleteScm(obj){
			return ProxyRequestService.post('e-bondquote/bondScm/deleteScm', obj||{
		...
		// 债券搜索
		searchBondBreed(obj){
			return ProxyRequestService.post('e-bondquote/bondOfr/searchBondBreed', obj||{
		...
		queryBondBaseInfo(obj){
			return ProxyRequestService.post('ainas/web/queryDetailBondBaseInfo', obj||{});
			// let deferred = $q.defer();
			// $http({
			// 	method: 'POST',
		...
		getIssuerListByFullName(obj){
			return ProxyRequestService.post('E_project_base/authority/getIssuerListByFullName',obj|| {});
			// let deferred = $q.defer();
			// $http({
			// 	method: 'POST',
		...
		year:{
			"data":[
				{"label": "",'checked':false,'id':'', "children": [
					{"label": "2017",'checked':false,'id':'2017', "children": false},
					{"label": "2016",'checked':false,'id':'2016', "children": false},
					{"label": "2015",'checked':false,'id':'2015', "children": false},
					{"label": "2014",'checked':false,'id':'2014', "children": false},
					{"label": "2013",'checked':false,'id':'2013', "children": false},
					{"label": "2012",'checked':false,'id':'2012', "children": false},
					{"label": "2011",'checked':false,'id':'2011', "children": false},
					{"label": "2010",'checked':false,'id':'2010', "children": false},
					{"label": "2009",'checked':false,'id':'2009', "children": false},
					{"label": "2008",'checked':false,'id':'2008', "children": false},
					{"label": "2007",'checked':false,'id':'2007', "children": false},
					{"label": "2006",'checked':false,'id':'2006', "children": false},
					{"label": "2005",'checked':false,'id':'2005', "children": false},
					{"label": "2004",'checked':false,'id':'2004', "children": false},
					{"label": "2003",'checked':false,'id':'2003', "children": false},
					{"label": "2002",'checked':false,'id':'2002', "children": false},
					{"label": "2001",'checked':false,'id':'2001', "children": false},
					{"label": "2000",'checked':false,'id':'2000', "children": false},
					{"label": "1999",'checked':false,'id':'1999', "children": false},
					{"label": "1998",'checked':false,'id':'1998', "children": false},
					{"label": "1997",'checked':false,'id':'1997', "children": false},
					{"label": "1996",'checked':false,'id':'1996', "children": false},
					{"label": "1995",'checked':false,'id':'1995', "children": false},
					{"label": "1994",'checked':false,'id':'1994', "children": false},
					{"label": "1993",'checked':false,'id':'1993', "children": false},
					{"label": "1992",'checked':false,'id':'1992', "children": false},
					{"label": "1991",'checked':false,'id':'1991', "children": false},
					{"label": "1990",'checked':false,'id':'1990', "children": false},
				]},
			]
		},
		section:{
